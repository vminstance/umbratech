...
namespace Umbra.Structures
{
    public class FaceList
    {
        ...
        static public FaceValidation GetFaceValidation(BlockVisibility thisBlock, BlockVisibility nextBlock)
        {
            if (thisBlock == BlockVisibility.Invisible && nextBlock == BlockVisibility.Invisible)
            {
                return FaceValidation.NoFaces;
            }
            if (thisBlock == BlockVisibility.Opaque && nextBlock == BlockVisibility.Invisible)
            {
                return FaceValidation.ThisFace;
            }
            if (thisBlock == BlockVisibility.Invisible && nextBlock == BlockVisibility.Opaque)
            {
