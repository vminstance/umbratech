...
namespace Umbra.Implementations
{
    public class Camera
    {
        ...
        public void Update()
        {
            ...
            {
                Direction -= MathHelper.WrapAngle((float)(Constants.Input.MouseCurrentState.X - Constants.ScreenResolution.X / 2) / 100.0F);
                Pitch = MathHelper.Clamp(Pitch - (float)(Constants.Input.MouseCurrentState.Y - Constants.ScreenResolution.Y / 2) / 100.0F, -MathHelper.PiOver2, MathHelper.PiOver2);
