...
namespace Umbra.Definitions
{
    static public class Constants
    {
        ...
        static public Vector2 ScreenResolution = new Vector2(1680, 900);
        ...
        // Camera
        static public bool CameraBobbingEnabled = false;
        ...
        public const float NoclipSpeed = 0.5F;

        static public float[] WalkingValues = { 0.015F, 0.015F, 0.12F, 0.015F }; // Acceleration, Friction, MaxSpeed, MinSpeed
        static public float[] RunningValues = { 0.03F, 0.03F, 0.18F, 0.03F };
        static public float[] FlyingValues = { 0.013F, 0.0F, 0.05F, 0.001F };
        static public float[] CurrentValues = WalkingValues;

        public const float JumpForce = 0.15F;
        ...
        public const string FramcounterFontFilename = FontPath + @"framecounter";
        ...
        // Settings
        public const bool SaveChunksDynamic = false;
        ...
        static public void SetupEngines(Main main)
        {
            ...
            Timing.AddEngine(Content);
            Timing.AddEngine(Graphics);
            Timing.AddEngine(Input);
            Timing.AddEngine(Overlay);
            Timing.AddEngine(Player);
            Timing.AddEngine(Sound);
